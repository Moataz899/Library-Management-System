    ...
    def _get_valid_email(self):
        while True:
            ...
            if "@" in email and len(email) > 0:
                ...
                print("Please enter a valid email (must contain '@' and be non-empty).")

    def _get_valid_phone_number(self):
        while True:
            try:
                phone_number = int(input("Please Enter Your Phone Number: ").strip())
                return phone_number
            except ValueError:
...
class Librarian(Person):
    def __init__(self):
        super().__init__()
        self.libraryId = input("Please Enter Your Library ID: ").strip()

    def display_info(self):
        print(f"Librarian Info: Name: {self.name}, Email: {self.email}, "
              f"Phone Number: {self.phoneNumber}, Library ID: {self.libraryId}")
        print("//" * 15)
...
class Member(Person):
    ...
    def display_info(self):
        print(f"Member Info: Name: {self.name}, Email: {self.email}, "
              f"Phone Number: {self.phoneNumber}, Member ID: {self.memberId}")
